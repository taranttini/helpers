...
// sample formatValue(1234, { thousand_separator: '.', decimal_separator: ',', money_symbol: 'R$' }); //R$ 12,34
// sample formatValue(123456, { thousand_separator: '.', decimal_separator: ',', money_symbol: 'R$' }); //R$ 1.234,56
// sample formatValue('123456789', { thousand_separator: '/', decimal_separator: '-', money_symbol: 'X' }); //"X 1/234/567-89"
